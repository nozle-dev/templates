...
import { Home, FolderKanban, Coins, Image as ImageIcon, Wand2, Users, BarChart3, Settings, CreditCard } from 'lucide-react'
...
export default function DashboardLayout({
  ...
  const navigation = [
    ...
    { name: 'Studio', href: '/dashboard/studio', icon: Wand2 },
